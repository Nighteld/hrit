...
export const fetchAgentLists = async (param) =>
  await api
    .post(API_ENDPOINTS.getAgents, param, {
      headers: {
  ...
  await api
    .post(API_ENDPOINTS.getAgentInfo, param, {
      headers: {
        Authorization: "Bearer " + getAppToken(),
    ...
    export const fetchStudentCounts = async (param) =>
  await api
    .post(API_ENDPOINTS.getStudentCount, param, {
      headers: {
        Authorization: "Bearer " + getAppToken(),
