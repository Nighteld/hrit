      ...
      <div className="section container">
       ...
       <div className="mb-15">
            ...
            <p>
              ...
              the practice of law. These core competencies are accomplished
              through:
            </p>
       <ul className="section-text">
        ...
        <li>Fundamentals of dispute processing and legal problem solution</li>
        <li>Fundamentals of professional responsibility and Identity.</li>
       </ul>
       </div>
       <section className="">
        <div className="">
          ...
          <h2 className="text-3xl font-bold tracking-tight">
            ...
            <p className="mt-4 text-muted-foreground">
              Comprehensive legal education programs designed to prepare students for successful careers in law.
            </p>
          </div>
