              ...
              <div className="md:flex">
                ...
                <div className="md:w-1/3 relative">
                  ...
                  {/* <Badge variant={notice.type === "event" ? "default" : "secondary"} className="absolute top-4 left-4">
                    {notice.eventCategory === "event" ? (
                      <Trophy className="w-3 h-3 mr-1" />
                    ) : (
                      <FileText className="w-3 h-3 mr-1" />
                    )}
                    {notice.eventCategory?.charAt(0)?.toUpperCase() + notice?.eventCategory?.slice(1)}
                  </Badge> */}
                </div>
                ...
                <div className="md:w-2/3 p-6">
                  <CardHeader className="p-0 mb-4">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                      ...
                      {notice.eventCategory}
                    </div>
                    <CardTitle className="text-2xl font-bold tracking-tight bg-text ">{notice.eventTitle}</CardTitle>
                  </CardHeader>
